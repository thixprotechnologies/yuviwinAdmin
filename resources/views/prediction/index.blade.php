                    ...
                    <div class="d-flex justify-content-between my-2">
                        ...
                        <div class="template-demo">
                            <a href="{{ route('admin.prediction') }}"
                                class="btn btn-gradient-primary btn-rounded btn-sm">Fast Parity</a>
                            ...
                            <a href="{{ route('admin.prediction.circle') }}"
                                class="btn btn-gradient-success btn-rounded btn-sm">Circle</a>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form class="forms-sample" action="{{ route('admin.prediction.ans') }}" method="POST">
                        @csrf
                        <input type="hidden" name="betting" value="fastParity">
