...
@push('breadcrumb-plugins')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin.users') }}">Agents</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between my-2">
                        <div class="text-left">
                            <h4 class="card-title">Add Agent/Accountent</h4>
                        </div>
                    </div>
                    <form class="forms-sample" method="post" action="{{route('admin.agent.addagent')}}">
                        @csrf
